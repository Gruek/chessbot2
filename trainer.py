...
class Trainer():
    ...
    def train_vs_stockfish(self, debug=False, think_time=10, depth=7, stockfish_depth=6):
        wins = 0
        draws = 0
        games = 0
        while True:
    ...
    def train_vs_self(self, debug=False, think_time=10, depth=7):
        white_wins = 0
        black_wins = 0
        draws = 0
        p1_wins = 0
    ...
    def train_vs_sf_and_self(self, debug=False, think_time=10, depth=6, stockfish_depth=7):
        #self play stats
        white_wins = 0
        black_wins = 0
        draws = 0
        ...
        while True:
            ...
            self.chbot.train_from_board(board)
            print('Wins:', wins, 'Draws:', sf_draws, 'Games:', games)
            sys.stdout.flush()
